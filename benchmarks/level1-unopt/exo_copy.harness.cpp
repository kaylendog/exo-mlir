...
#include <exocc/level1-unopt/exo_copy.h>
...
BENCHMARK(BM_exo_copy)->RangeMultiplier(2)->Range(16, 1 << 16)->Iterations(16);
...
BENCHMARK(BM_exomlir_exo_copy)->RangeMultiplier(2)->Range(16, 1 << 16)->Iterations(16);
