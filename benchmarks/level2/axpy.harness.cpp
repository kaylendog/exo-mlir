...
extern "C" void exomlir_exo_saxpy_stride_1(int32_t n, const float *a, const float *x, float *y);
...
BENCHMARK(BM_exo_saxpy_stride_1)->RangeMultiplier(2)->Range(16, 1024);
...
BENCHMARK(BM_exomlir_exo_saxpy_stride_1)->RangeMultiplier(2)->Range(16, 1024);
