...
from exoblas.higher_order import filter_cursors
...
def bool_inspec_op(func):
    class BooleanInspectionOperation:
        ...
        def __and__(self, other):
            ...
            return BooleanInspectionOperation(
                lambda *args, **kwargs: self(*args, **kwargs) and other(*args, **kwargs)
            )
        ...
        def __or__(self, other):
            if not isinstance(other, BooleanInspectionOperation):
                return NotImplemented
            return BooleanInspectionOperation(
                lambda *args, **kwargs: self(*args, **kwargs) or other(*args, **kwargs)
            )

        def __invert__(self):
            return BooleanInspectionOperation(
                lambda *args, **kwargs: not self(*args, **kwargs)
            )
